...
public class PdfManager implements IEventHandler {
	...
	try {
	    ...
	    htmlPre += "		    src: url('" + this.getClass().getResource("resources/TradeGothic.woff")
		    + "') format('woff');";
	    // htmlPre += " font-family: 'Freehand-Regular';";
	    // htmlPre += " src:
	    // url('"+this.getClass().getResource("resources/Freehand591BT-RegularA.woff")+"')
	    // format('woff');";
	    // htmlPre += " font-family: 'MaximeStd-Regular';";
	    // htmlPre += " src:
	    // url('"+this.getClass().getResource("resources/MaximeStd-Regular.woff")+"')
	    // format('woff');";
	    htmlPre += "		}";
	    htmlPre += "		* {";
	    htmlPre += "		    font-family: 'FreeSans';";  // 'FreeSerif'
								        // o
								        // 'FreeMono'
	    htmlPre += "		    font-size: 11pt;";
	    htmlPre += "		}";
	    htmlPre += "		@page{";
	    htmlPre += " 			margin: " + MARGIN_TOP + "pt " + MARGIN_RIGHT + "pt " + MARGIN_BOTTOM
		    + "pt " + MARGIN_LEFT + "pt;";
	    ...
	    htmlPre += "		}";
	    htmlPre += "		tr > td { ";
	    htmlPre += "			border-color: #778899; font-size: 9pt; padding: 4pt; ";
	    htmlPre += "		}";
	    htmlPre += "		tr.header-row > td { ";
	    htmlPre += "			background-color: #778899; color: white; font-size: 14pt; font-weight: bold; padding: 15pt 6pt; line-height: 1.1em; ";
	    htmlPre += "		}";
	    htmlPre += "		tr.subheader-row > td { ";
	    htmlPre += "			background-color: #e6e6fa; color: #778899; font-size: 11pt; padding: 4pt;";
	    htmlPre += "		}";
	    htmlPre += "		.red {";
	    htmlPre += "		    color: red;";
	    htmlPre += "		}";
	    ...
	    this.pdfDocument.addEventHandler(PdfDocumentEvent.START_PAGE, this);	// Després
											// de
											// crear
											// la
											// pàgina
		...
		// Document document = new Document(this.pdfDocument,
		// PageSize.A4.rotate());
	    }

	    ConverterProperties converterProperties = new ConverterProperties();
	    Document document = HtmlConverter.convertToDocument(htmlPre + htmlContent + htmlPost, this.pdfDocument,
		    converterProperties);
	...
	Paragraph p = new Paragraph(HEADER_TEXT).setFont(headerFont).setFontSize(9f).setMultipliedLeading(1); // Line
													      // height
													      // 1
